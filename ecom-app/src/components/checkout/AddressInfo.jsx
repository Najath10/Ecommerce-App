...
import { FaAddressBook, FaSadCry } from 'react-icons/fa';
...
const AddressInfo = ({address}) => {
    ...
    const noAddresssExist = !address || address.length === 0;
        ...
        {noAddresssExist ? (
            <div className='p-6 rounded-lg max-w-md mx-auto flex flex-col items-center justify-center'>
                ...
                <p className='mb-6 text-slate-800 text-center '>
                    Please add your address to complete Purshase
                </p>
                <button
                ...
                <>
                 ...
                 {address.length  > 0 && (
                    <div className=' flex justify-end'>
                        <button
                            onClick={addNewAddressHandler}
                            className='px-4 py-2 mt-2  bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition-all'>
                         Add New
                        </button>
                    </div>
                 )} 
